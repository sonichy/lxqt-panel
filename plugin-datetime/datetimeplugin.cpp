    ...
    ILXQtPanelPlugin(startupInfo)
{
    ...
    connect(mWidget, &QToolButton::clicked, this, [this] {
        ...
        calendar->setWindowTitle(QSL("Calendar"));
...
void DatetimePlugin::refresh()
{
    ...
    mWidget->setText(currentDateTime.toString(QSL("HH:mm\nM/d ddd")));
    mWidget->setToolTip(currentDateTime.toString(QSL("yyyy-MM-dd dddd HH:mm:ss")) + QSL("\n") + mText.replace(QSL("\\n"), QSL("\n")));
}
